...
### Bài 4
So rather than sitting down to work out

Is this relative, or is this absolute?, just think whether you need an on, in or at in English, and if you do, you need に in Japanese. And if you don't, you don't need に in Japanese. It's really as simple as that.
...
https://kellenok.github.io/cure-script/assets/image994.B4e7LrL4.webp (Bảng cho Godan)
...
うたったしょうじょ – the girl who sang.
うたったしょうじょがねている – the girl who sang is sleeping.

Using adjectival-nouns as adjectives. When we turn だ or です into a white engine, when we connect it to anything, it changes its form from だ to な.
